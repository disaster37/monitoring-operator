...
IMAGE_TAG_BASE ?= quay.io/webcenter/monitoring-operator
...
bundle: manifests kustomize ## Generate bundle manifests and metadata, then validate generated files.
	...
	cd config/manager && $(KUSTOMIZE) edit set image controller=$(IMG)
	$(KUSTOMIZE) build config/manifests | operator-sdk generate bundle --channels stable -q --overwrite --version $(VERSION) $(BUNDLE_METADATA_OPTS)
