...
func (r *IngressReconciler) readForCentreonPlatform(ctx context.Context, ingress *networkv1.Ingress, platform *v1alpha1.Platform, data map[string]any, meta any) (res ctrl.Result, err error) {

	// Get endpoint spec from platform
	endpointSpec := platform.Spec.CentreonSettings.Endpoint
	if endpointSpec == nil {
		r.log.Warning("It's recommanded to set some default endpoint values on target platfrom. It avoid to set on each ingress all Centreon service properties as annotations")
	}
	...
	placeholders := generatePlaceholdersIngress(ingress)
...
func (r *IngressReconciler) createForCentreonPlatform(ctx context.Context, resource client.Object, data map[string]interface{}, meta interface{}) (res ctrl.Result, err error) {
	var d any
...
func (r *IngressReconciler) updateForCentreonPlatform(ctx context.Context, resource client.Object, data map[string]interface{}, meta interface{}) (res ctrl.Result, err error) {
	var d any
...
func (r *IngressReconciler) diffForCentreonPlatform(resource client.Object, data map[string]interface{}, meta interface{}) (diff controller.Diff, err error) {
	var (
		d          any
		currentCS  *v1alpha1.CentreonService
		expectedCS *v1alpha1.CentreonService
